;;与Linux版的区别在于
;;将require的脚本替换为正确路径，注意不是全部替换，根据实际
;;将s;(require\s')([\w\-\+]*)替换为load-file "~/.emacs.d/lisp/\2\.el" 
;;require linum不用替换
...
(defalias 'make-local-hook
  (if (featurep 'xemacs)
      'make-local-hook
    'ignore))
(load-file "~/.emacs.d/lisp/util.el")
...
(load-file "~/.emacs.d/lisp/ahei-misc.el")
(load-file "~/.emacs.d/lisp/eval-after-load.el")

;;VI模式
;;我在emaci.el文件中把when file exists的hook动作设为emaci-mode-off
(load-file "~/.emacs.d/lisp/emaci.el")
(load-file "~/.emacs.d/lisp/emaci-settings.el")
...
(load-file "~/.emacs.d/auto-complete/auto-complete-config.el")
...
;;光标自动改变
(load-file "~/.emacs.d/lisp/cursor-chg.el")
(load-file "~/.emacs.d/lisp/cursor-change.el")  
...
(load-file "~/.emacs.d/lisp/icomplete+.el")
(load-file "~/.emacs.d/lisp/icomplete-settings.el") ;; in this file, I modify the name 'my-icomplete' to 'icomplete'

;;操作符自动隔开模式（自动空格）依赖三个文件
;;https://github.com/davidshepherd7/electric-operator
(load-file "~/.emacs.d/lisp/subr-x.el")
(load-file "~/.emacs.d/lisp/names.el")
